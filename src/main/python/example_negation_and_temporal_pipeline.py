...
from example_negation import ExampleNegationAnnotator
from example_temporal import ExampleTemporalAnnotator
...
def main():
    ...
    pipeline.add(ExampleNegationAnnotator())
    pipeline.add(ExampleTemporalAnnotator())
